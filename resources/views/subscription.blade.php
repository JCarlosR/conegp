            ...
            <div class="col s12 m6">
                <div class="icon-block">
                    ...
                    <form action="#">
                        ...
                        <div class="row">
                            <div class="input-field col s6">
                                <input name="identity_card" type="text" class="validate">
                        ...
                        <div class="row">
                            ...
                            <div class="input-field col s6">
                                <input id="email_confirmation" type="text" class="validate">
                        ...
                        <div class="row">
                            <div class="input-field col s6">
                                <select name="occupation">
                                    ...
                                    <option value="M">Miembro RUDP</option>
                                </select>
                                <label for="occupation">Ocupación</label>
                            </div>
                            <div class="input-field col s6">
                                <input name="workplace" type="text" class="validate">
                        ...
                        <div class="row">
                            <div class="input-field col s6">
                                <input name="operation_number" type="text" class="validate">
                                <label for="operation_number">Nro de operación</label>
                            </div>
                            <div class="input-field col s6">
                                <input name="payment_date" type="date" class="datepicker">
